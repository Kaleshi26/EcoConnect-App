...
export default function OrgProfile() {
  ...
  const stats: ProfileStats = React.useMemo(() => {
  ...
  const StatCard = ({ 
    ...
    return (
      <View className={`rounded-2xl p-4 bg-gradient-to-br ${colorMap[color]} shadow-lg`}>
  ...
  const MenuItem = ({ 
    ...
    <Pressable 
      onPress={onPress}
      className="flex-row items-center justify-between py-4 px-2 border-b border-gray-100 active:bg-gray-50"
    >
        ...
        <View className="flex-row items-center">
          ...
          <View className="flex-1">
            <Text className="text-2xl font-bold text-white">
              {profile?.orgName || profile?.displayName || "Organizer"}
            </Text>
        ...
        <View className="px-6 space-y-6">
          ...
          <View className="bg-white rounded-3xl shadow-xl border-2 border-gray-100 overflow-hidden">
            ...
            <MenuItem
              ...
              subtitle={profile?.orgName || "Add organization name"}
              onPress={() => Alert.alert("Organization Info", "Organization management coming soon!")}
            />
            <MenuItem
          ...
          <View className="bg-white rounded-3xl shadow-xl border-2 border-gray-100 overflow-hidden">
            ...
            <MenuItem
              icon="mail-outline"
              title="Email Updates"
              subtitle="Get weekly impact reports"
              showArrow={false}
              rightElement={
                <Switch
                  value={emailUpdates}
                  ...
                  trackColor={{ false: '#e5e7eb', true: '#a5b4fc' }}
                  thumbColor={emailUpdates ? '#4f46e5' : '#9ca3af'}
                />
              }
            />
          </View>
          ...
          <View className="bg-white rounded-3xl shadow-xl border-2 border-gray-100 overflow-hidden">
            <View className="p-4 border-b border-gray-100">
              <Text className="text-lg font-bold text-gray-900">Support & Resources</Text>
            </View>
            <MenuItem
              icon="help-circle-outline"
              title="Help & Support"
              subtitle="Get help with the app"
              onPress={() => Alert.alert("Help & Support", "Support center coming soon!")}
            />
            <MenuItem
              icon="document-text-outline"
              title="Resources"
              subtitle="Event planning guides and tips"
              onPress={() => Alert.alert("Resources", "Resource library coming soon!")}
            />
            <MenuItem
              icon="star-outline"
              title="Rate Our App"
          ...
          <View className="bg-white rounded-3xl shadow-xl border-2 border-gray-100 overflow-hidden">
            ...
            <MenuItem
              ...
              title="About EcoConnect"
              subtitle="Learn more about our mission"
              onPress={() => Alert.alert("About EcoConnect", "Making the world cleaner, one event at a time! 🌍")}
            />
            <MenuItem
              icon="document-outline"
              title="Terms of Service"
              onPress={() => Alert.alert("Terms of Service", "Terms and conditions content")}
            />
            <MenuItem
            ...
            />
            <Text className="text-gray-500 text-xs text-center p-4">
              EcoConnect v1.0.0 • Making the world cleaner 🌊
            </Text>
          </View>
          ...
          <Pressable 
            ...
            className="bg-gradient-to-r from-red-500 to-red-600 rounded-2xl py-4 items-center shadow-xl active:opacity-80"
          >
            <View className="flex-row items-center">
          ...
          <View className="bg-gradient-to-r from-green-500 to-emerald-600 rounded-3xl p-6 shadow-xl">
            ...
            <Text className="text-white/90 text-center text-sm">
              You've organized {stats.totalEvents} events and helped remove {stats.totalWasteCollected} kg of waste from our environment. Thank you for your dedication to a cleaner planet! 🌟
            </Text>
          </View>
        </View>
      </ScrollView>
